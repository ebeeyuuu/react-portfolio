...
const GradientMaterial = shaderMaterial(
  ...
  `
    ...
    void main() {
      vec2 uv = vUv;
      float noise = snoise(vec3(uv * density, time * speed));
...
// Extend the material with Three.js
extend({ GradientMaterial })

// Create a component for the animated plane
function AnimatedPlane({ baseColor, accentColor, density, speed, intensity, vignetteIntensity }: MovingGradientProps) {
  ...
  const uniforms = useMemo(() => ({
    ...
    intensity,
    vignetteIntensity,
  }), [baseColor, accentColor, density, speed, intensity, vignetteIntensity])
