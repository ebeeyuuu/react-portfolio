...
const Contact = () => {
  return (
    <div id="contact" className="mt-[1300px] w-full justify-center flex mb-[50px]">
      <div className="flex flex-col">
        <div className="text-center text-3xl font-semibold">
          Want to chat?
        </div>
        <div className="text-xl font-medium w-full mt-[30px] mb-[30px] flex flex-col items-center gap-y-[50px] text-center">
          <div className="w-[calc(30vw-10rem)] min-w-[200px]">
